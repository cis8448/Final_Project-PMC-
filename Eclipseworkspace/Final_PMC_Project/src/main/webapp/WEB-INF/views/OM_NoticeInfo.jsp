...
<body>
	...
	<section>
		...
		<br>
		<div class=left>
			<p class="content">작성자 :</p>
			<p class="content">글제목 :</p>
			<p class="content">작성일시 :</p>
			<p>글내용 :</p>

		</div>

		<div class=right>
			<p class="content" id="no_p_id">${OMnotice.no_p_id}</p>
			<p class="content">${OMnotice.no_title}</p>
			<p class="content">${OMnotice.no_date}</p>
			<p>${OMnotice.no_content}</p>

		</div>

		<br>
		<div class="LastButton">
			<a href="./OM_Notice" class="button2">뒤로가기</a>
		</div>
	</section>
	<footer>
